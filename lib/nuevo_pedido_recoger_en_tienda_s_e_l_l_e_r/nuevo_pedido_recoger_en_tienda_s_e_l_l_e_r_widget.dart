...
class NuevoPedidoRecogerEnTiendaSELLERWidget extends StatefulWidget {
  const NuevoPedidoRecogerEnTiendaSELLERWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _NuevoPedidoRecogerEnTiendaSELLERWidgetState createState() =>
      _NuevoPedidoRecogerEnTiendaSELLERWidgetState();
}

class _NuevoPedidoRecogerEnTiendaSELLERWidgetState
    extends State<NuevoPedidoRecogerEnTiendaSELLERWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord>
            nuevoPedidoRecogerEnTiendaSELLEROrdersForStoresRecordList =
            snapshot.data;
        final nuevoPedidoRecogerEnTiendaSELLEROrdersForStoresRecord =
            nuevoPedidoRecogerEnTiendaSELLEROrdersForStoresRecordList.isNotEmpty
                ? nuevoPedidoRecogerEnTiendaSELLEROrdersForStoresRecordList
                    .first
                : null;
        return Scaffold(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      nuevoPedidoRecogerEnTiendaSELLEROrdersForStoresRecord
                                                          .customerName,
