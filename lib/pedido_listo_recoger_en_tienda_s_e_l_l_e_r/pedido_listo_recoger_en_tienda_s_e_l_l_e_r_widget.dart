...
class PedidoListoRecogerEnTiendaSELLERWidget extends StatefulWidget {
  const PedidoListoRecogerEnTiendaSELLERWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _PedidoListoRecogerEnTiendaSELLERWidgetState createState() =>
      _PedidoListoRecogerEnTiendaSELLERWidgetState();
}

class _PedidoListoRecogerEnTiendaSELLERWidgetState
    extends State<PedidoListoRecogerEnTiendaSELLERWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord>
            pedidoListoRecogerEnTiendaSELLEROrdersForStoresRecordList =
            snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final pedidoListoRecogerEnTiendaSELLEROrdersForStoresRecord =
            pedidoListoRecogerEnTiendaSELLEROrdersForStoresRecordList.isNotEmpty
                ? pedidoListoRecogerEnTiendaSELLEROrdersForStoresRecordList
                    .first
                : null;
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              pedidoListoRecogerEnTiendaSELLEROrdersForStoresRecord.id,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await actions.markPickupOrderAsReady(
                        pedidoListoRecogerEnTiendaSELLEROrdersForStoresRecord
                            .id,
                      );
