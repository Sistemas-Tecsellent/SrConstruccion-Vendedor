...
class NuevoPedido15DIASWidget extends StatefulWidget {
  const NuevoPedido15DIASWidget({
    Key key,
    this.normalOrderId,
  }) : super(key: key);
  ...
  @override
  _NuevoPedido15DIASWidgetState createState() =>
      _NuevoPedido15DIASWidgetState();
}

class _NuevoPedido15DIASWidgetState extends State<NuevoPedido15DIASWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      stream: queryOrdersForStoresRecord(
        queryBuilder: (ordersForStoresRecord) =>
            ordersForStoresRecord.where('id', isEqualTo: widget.normalOrderId),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord> nuevoPedido15DIASOrdersForStoresRecordList =
            snapshot.data;
        final nuevoPedido15DIASOrdersForStoresRecord =
            nuevoPedido15DIASOrdersForStoresRecordList.isNotEmpty
                ? nuevoPedido15DIASOrdersForStoresRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      nuevoPedido15DIASOrdersForStoresRecord
                                                          .customerName,
