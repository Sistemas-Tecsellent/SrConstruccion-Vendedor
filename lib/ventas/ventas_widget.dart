                                                                                      ...
                                                                                      child: InkWell(
                                                                                        onTap: () async {
                                                                                          context.pushNamed(
                                                                                            'IngresoDia',
                                                                                            queryParams: {
                                                                                              'month': serializeParam(columnEarningHistoryRecord.month, ParamType.String),
                                                                                              'dayInNumber': serializeParam(columnEarningHistoryRecord.dayInNumber, ParamType.int),
                                                                                              'year': serializeParam(columnEarningHistoryRecord.year, ParamType.int),
                                                                                            }.withoutNulls,
                                                                                          );
                                                                                        },
                                                                                        child: Container(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        onTap: () async {
                                                                                          context.pushNamed(
                                                                                            ...
                                                                                            queryParams: {
                                                                                              'month': serializeParam(columnEarningHistoryRecord.month, ParamType.String),
                                                                                              'dayInNumber': serializeParam(0, ParamType.int),
                                                                                              'year': serializeParam(columnEarningHistoryRecord.year, ParamType.int),
                                                                                            }.withoutNulls,
                                                                                          );
                                                                                        },
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        context
                                            .pushNamed('SolicitudesDevolucion');
                                      },
                                      child: Container(
                                        width:
                                            MediaQuery.of(context).size.width,
