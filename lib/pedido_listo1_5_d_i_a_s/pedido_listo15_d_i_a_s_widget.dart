...
class PedidoListo15DIASWidget extends StatefulWidget {
  const PedidoListo15DIASWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _PedidoListo15DIASWidgetState createState() =>
      _PedidoListo15DIASWidgetState();
}

class _PedidoListo15DIASWidgetState extends State<PedidoListo15DIASWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord> pedidoListo15DIASOrdersForStoresRecordList =
            snapshot.data;
        final pedidoListo15DIASOrdersForStoresRecord =
            pedidoListo15DIASOrdersForStoresRecordList.isNotEmpty
                ? pedidoListo15DIASOrdersForStoresRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      pedidoListo15DIASOrdersForStoresRecord
                                                          .customerName,
                    ...
                    if ((pedidoListo15DIASOrdersForStoresRecord.shipmentType) ==
                        'paqueteria')
                      Container(
