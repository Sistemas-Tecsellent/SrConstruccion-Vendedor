...
class NuevoPedidoSELLEREXPRESSWidget extends StatefulWidget {
  const NuevoPedidoSELLEREXPRESSWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _NuevoPedidoSELLEREXPRESSWidgetState createState() =>
      _NuevoPedidoSELLEREXPRESSWidgetState();
}

class _NuevoPedidoSELLEREXPRESSWidgetState
    extends State<NuevoPedidoSELLEREXPRESSWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord>
            nuevoPedidoSELLEREXPRESSOrdersForStoresRecordList = snapshot.data;
        final nuevoPedidoSELLEREXPRESSOrdersForStoresRecord =
            nuevoPedidoSELLEREXPRESSOrdersForStoresRecordList.isNotEmpty
                ? nuevoPedidoSELLEREXPRESSOrdersForStoresRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                    ...
                    onPressed: () async {
                      if ((radioButtonValue) == 'Solicitar Repartidor') {
                        await actions.updateOrderDecision(
                          widget.orderId,
                          nuevoPedidoSELLEREXPRESSOrdersForStoresRecord
                              .bundleId,
                          'accepted',
                          '----',
                        );
                        ...
                        children: [
                          Container(
                            ...
                            child: FlutterFlowRadioButton(
                              options: ['Mi Repartidor', 'Solicitar Repartidor']
                                  .toList(),
