...
class PorEntregarSELLER5DIASWidget extends StatefulWidget {
  const PorEntregarSELLER5DIASWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _PorEntregarSELLER5DIASWidgetState createState() =>
      _PorEntregarSELLER5DIASWidgetState();
}

class _PorEntregarSELLER5DIASWidgetState
    extends State<PorEntregarSELLER5DIASWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord>
            porEntregarSELLER5DIASOrdersForStoresRecordList = snapshot.data;
        final porEntregarSELLER5DIASOrdersForStoresRecord =
            porEntregarSELLER5DIASOrdersForStoresRecordList.isNotEmpty
                ? porEntregarSELLER5DIASOrdersForStoresRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
          ...
          floatingActionButton: Visibility(
            visible:
                (porEntregarSELLER5DIASOrdersForStoresRecord.deliveredBy) ==
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await DeliverNormalOrderByThirdPartyCall.call(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      porEntregarSELLER5DIASOrdersForStoresRecord
                                                          .customerName,
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            if ((porEntregarSELLER5DIASOrdersForStoresRecord
                                    .deliveredBy) ==
                                'Paquetería / Flete / Otro')
                              Container(
                                width: double.infinity,
