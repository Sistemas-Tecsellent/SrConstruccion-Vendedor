...
class PorEntregarSELLEREXPRESSWidget extends StatefulWidget {
  const PorEntregarSELLEREXPRESSWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _PorEntregarSELLEREXPRESSWidgetState createState() =>
      _PorEntregarSELLEREXPRESSWidgetState();
}

class _PorEntregarSELLEREXPRESSWidgetState
    extends State<PorEntregarSELLEREXPRESSWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord>
            porEntregarSELLEREXPRESSOrdersForStoresRecordList = snapshot.data;
        final porEntregarSELLEREXPRESSOrdersForStoresRecord =
            porEntregarSELLEREXPRESSOrdersForStoresRecordList.isNotEmpty
                ? porEntregarSELLEREXPRESSOrdersForStoresRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      porEntregarSELLEREXPRESSOrdersForStoresRecord
                                                          .customerName,
                    ...
                    if ((porEntregarSELLEREXPRESSOrdersForStoresRecord
                            .deliveredBy) ==
                        'associateDeliverer')
                      Container(
                        width: MediaQuery.of(context).size.width * 0.9,
                        ...
                        child: StreamBuilder<List<DeliverersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<DeliverersRecord>
                                repartirDeliverersRecordList = snapshot.data;
                            // Return an empty Container when the document does not exist.
                            if (snapshot.data.isEmpty) {
                              return Container();
                            }
                            final repartirDeliverersRecord =
                                repartirDeliverersRecordList.isNotEmpty
                                    ? repartirDeliverersRecordList.first
                                    : null;
                            return Container(
                              width: MediaQuery.of(context).size.width * 0.9,
                              decoration: BoxDecoration(
                    ...
                    if ((porEntregarSELLEREXPRESSOrdersForStoresRecord
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(13, 0, 20, 0),
                          child: StreamBuilder<List<DeliverersRecord>>(
                            stream: queryDeliverersRecord(
                              queryBuilder: (deliverersRecord) =>
                                  deliverersRecord.where('uid',
