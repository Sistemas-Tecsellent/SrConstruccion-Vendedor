...
class PedidoListoEXPRESSWidget extends StatefulWidget {
  const PedidoListoEXPRESSWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _PedidoListoEXPRESSWidgetState createState() =>
      _PedidoListoEXPRESSWidgetState();
}

class _PedidoListoEXPRESSWidgetState extends State<PedidoListoEXPRESSWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord>
            pedidoListoEXPRESSOrdersForStoresRecordList = snapshot.data;
        final pedidoListoEXPRESSOrdersForStoresRecord =
            pedidoListoEXPRESSOrdersForStoresRecordList.isNotEmpty
                ? pedidoListoEXPRESSOrdersForStoresRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
            ...
            title: Text(
              pedidoListoEXPRESSOrdersForStoresRecord.id
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        pedidoListoEXPRESSOrdersForStoresRecord
                                                            .customerName,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
