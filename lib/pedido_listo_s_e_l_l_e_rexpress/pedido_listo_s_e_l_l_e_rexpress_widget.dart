...
class PedidoListoSELLERexpressWidget extends StatefulWidget {
  const PedidoListoSELLERexpressWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _PedidoListoSELLERexpressWidgetState createState() =>
      _PedidoListoSELLERexpressWidgetState();
}

class _PedidoListoSELLERexpressWidgetState
    extends State<PedidoListoSELLERexpressWidget> {
    ...
    return StreamBuilder<List<OrdersForStoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForStoresRecord>
            pedidoListoSELLERexpressOrdersForStoresRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final pedidoListoSELLERexpressOrdersForStoresRecord =
            pedidoListoSELLERexpressOrdersForStoresRecordList.isNotEmpty
                ? pedidoListoSELLERexpressOrdersForStoresRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
            ...
            title: Text(
              pedidoListoSELLERexpressOrdersForStoresRecord.id,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if ((pedidoListoSELLERexpressOrdersForStoresRecord
                              .deliveredBy) ==
                          'associateDeliverer') {
                        await PrepareExpressOrderOwnDeliveryCall.call(
                          bundleId:
                                ...
                                child: StreamBuilder<List<DeliverersRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<DeliverersRecord>
                                        rowDeliverersRecordList = snapshot.data;
                                    // Return an empty Container when the document does not exist.
                                    if (snapshot.data.isEmpty) {
                                      return Container();
                                    }
