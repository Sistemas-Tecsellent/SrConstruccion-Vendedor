              ...
              children: [
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      isValid = await actions.validateCode(
                      ...
                      if (isValid) {
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              title: Text('Codigo no valido'),
                              content:
                                  Text('Verifique que el codigo sea correcto'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText:
                                              'Pide al cliente el código de entrega',
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  5, 0, 0, 10),
                                          child: Text(
                                            'El código que ingresaste es inválido.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText1
                                                .override(
                                                  fontFamily: 'Montserrat',
